              ...
              return Column(
                ...
                children: [
                  const Padding(
                    ...
                    child: Text('Select Folder', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18,color:Colors.black)),
                  ),
                  const Divider(),
                  Expanded(
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.document_scanner_outlined, size: 80, color: Theme.of(context).colorScheme.primary.withValues(alpha: 0.35)),
            ...
            children: [
              ...
              Positioned(
                ...
                child: GestureDetector(
                  ...
                  child: CircleAvatar(
                    radius: 14,
                    backgroundColor: const Color(0xFF1565C0).withValues(alpha: 0.9),
        ...
        return Padding(
          ...
          child: Container(
            ...
            child: ListTile(
              ...
              trailing: const Icon(Icons.drag_handle, color: Color(0xFF1565C0)),
            ),
          ),
        );
      },
